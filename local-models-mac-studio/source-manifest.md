...
- `/Users/stefanvalentinovpetrov/Documents/GitHub/ML-notebooks`

Reason:

- It is the intended personal GitHub notebook repository: `https://github.com/petrovs12/ML-notebooks.git`.
- `langgraph_experiments` was the first destination used by mistake and was later cleaned up with a deletion commit.
...
- Branch: `main`
- HEAD: `756d2e3251a8bb48b2458f82bc4ff85cc63dde94`
- Existing unrelated dirty files: `ml-notebooks-uv/`

Only `local-models-mac-studio/` should be staged for this commit.
